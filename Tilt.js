...
// 1) Tilt change event:
// This will output the x,y & percentages of tilting.
...
//             });
// --------------------------------------------------------------------------------------------------------------------
// 3) Disable X or Y axis:
// Setting this option will disable the X-Axis or Y-Axis on the tilt element.
//         =>  <div data-tilt data-tilt-axis="y"></div> // to disable the x axis
//         =>  <div data-tilt data-tilt-axis="x"></div> // to disable the y axis
// --------------------------------------------------------------------------------------------------------------------
// 4) Start tilt position:
// Setting this option will tilt the element at specific degrees at page load.
// --------------------------------------------------------------------------------------------------------------------
//         =>  <div data-tilt data-tilt-startX="20" data-tilt-startY="-20"></div>
// 5) Scale on hover:
